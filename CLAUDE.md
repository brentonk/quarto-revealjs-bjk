...
- Theme classes are API: `.alert`, `.fg`, `.bg`, `.button`, `.example`, `.tight`, `.wide-table`, `.v-center`, `.etable`, `.columns3070/.columns7030/.columns4060/.columns6040`. Restyle freely; never rename or drop.
